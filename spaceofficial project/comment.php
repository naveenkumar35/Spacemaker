...
define('HOST','localhost');
 define('USERNAME', 'id10319915_root');
 define('PASSWORD','naveen1999');
 define('DB','id10319915_spaceofficial');;
...
?>
   ...
   <?php
    ...
    ?>
    <div>
    <a href="signup.html" id="signup" style="text-decoration: none;">Sign-up</a>
    </div>
